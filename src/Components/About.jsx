...
const About = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-12'>
            <h2 data-aos="fade-up" className='text-5xl font-semibold text-center'>About Us</h2>

            <div className='text-[#d0d0d0] px-10'>
                <p data-aos="fade-up" className='my-4'>Welcome to EnergizeFit, where fitness meets empowerment. Our gym is more than just a place to work out; it's a community where individuals of all ages and fitness levels come together to achieve their goals, build discipline, and enhance their well-being.</p>

                <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>Our Mission</h4>

                <p data-aos="fade-up" className='my-4'>At EnergizeFit, our mission is to inspire and empower you to reach your full potential through fitness. We believe that fitness is not just about physical strength, but also about mental and emotional resilience. Our goal is to support your journey toward a healthier, stronger, and more confident you.</p>

                <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>Instructors</h4>

                <p data-aos="fade-up" className='my-4'>Our team of dedicated and certified trainers is here to guide you every step of the way. With a deep passion for fitness and a commitment to your success, our trainers bring both expertise and motivation to help you achieve your goals. Whether you're a beginner or a seasoned athlete, our instructors tailor their approach to meet your individual needs.</p>

                <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>Training Environment</h4>

                <p data-aos="fade-up" className='my-4'>Our state-of-the-art gym is designed to provide a safe, motivating, and supportive environment for all members. From cutting-edge equipment to a variety of workout spaces, we have everything you need to excel in your fitness journey. Whether you're here for strength training, cardio, or flexibility, you'll find the resources and community support you need.</p>

                <div className='my-6'>
                    <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>What We Offer</h4>
                    <div className='px-8'>
                        <div data-aos="fade-up" className='flex gap-6 my-2'>
                ...
                <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>Join Us</h4>
                <p data-aos="fade-up" className='my-4'>We invite you to join the EnergizeFit community and take the first step towards a healthier, fitter, and more confident you. Whether your goal is to build muscle, lose weight, or simply stay active, EnergizeFit is here to support your journey.
                ...
                <h4 data-aos="fade-up-right" className='text-2xl text-[#E6533C] font-semibold'>Contact Us</h4>
                <p data-aos="fade-up" className='my-4'>For inquiries, class schedules, and membership information, please call 9999243492.</p>
            </div>
        </div>
    );
};
