...
const BMI_calculator = () => {
    return (
        <div className='mt-16'>
            ...
            <p className='text-sm  my-4 max-w-[600px] mx-auto text-[#767575]'>We believe fitness should be accessible to everyone, everywhere, regardless br of income or access to a gym.</p>
            ...
            <div className='mt-12 bg-[#222222] p-12 lg:flex justify-around'>
                ...
                <div className='mt-12 lg:mt-0'>
                    ...
                    <form className='mt-4'>
                        ...
                        <button className="btn bg-[#E6533C] text-white rounded-full w-1/2 mt-4">Calculate</button>
                    </form>
                </div>
