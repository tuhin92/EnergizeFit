...
const Team = () => {
    return (
        <div className='max-w-7xl mx-auto mt-16'>
            ...
            <p className='text-xs text-[#767575] text-center mt-3'>We believe fitness should be accessible to everyone, everywhere, regardless of income or <br /> access to a gym.</p>


            <div className='mt-12 rounded-xl p-6 bg-[#222222] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className='relative h-[320px] w-full card'>
